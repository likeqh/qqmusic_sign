window = this;
navigator = {
	userAgent: 'Mozilla/5.0 (Linux; Android 7.1.2; VOG-AL00 Build/N2G48H; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/68.0.3440.70 Mobile Safari/537.36 V1_AND_SQ_8.5.5_1630_YYB_D A_8050500 PA QQ/8.5.5.5105 NetType/WIFI WebP/0.4.1 Pixel/720 StatusBarHeight/37 SimpleUISwitch/0 QQTheme/1000 InMagicWin/0'
}
location = {
	host: 'y.qq.com'
}
var I = "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ?
	self : void 0;
var U = function() {
	...
	function f(a, s, c, l, p, e, t, o) {
		...
		var d, i = [],
			r = null;
		Function.prototype.bind || (d = [].slice, Function.prototype.bind = function(e) {
		...
		for (var u = [function() {
				...
				function() {
					for (var n = s[a++], i = [], e = s[a++], t = s[a++], r = [], o = 0; o < e; o++) i[s[a++]] =
						l[s[a++]];
					for (o = 0; o < t; o++) r[o] = s[a++];
					l.push(function e() {
						var t = i.slice(0);
						t[0] = [this],
							t[1] = [arguments],
							t[2] = [e];
						for (var o = 0; o < r.length && o < arguments.length; o++) 0 < r[o] && (t[r[
							o]] = [arguments[o]]);
						return f(n, s, c, t, p)
					})
				},
			...
			for (var m = !1; !m;) m = u[s[a++]]();
			if (r) throw r;
			return n ? (l.pop(), l.slice(3 + f.v)) : l.pop()
		} catch (e) {
			var h = i.pop();
			if (void 0 === h) throw e;
			r = e,
		...
		f(0,
			function(e) {
				var t = e[1],
					o = [],
					n = function(e) {
						for (var t, o, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
								.split(""), i = String(e).replace(/[=]+$/, ""), r = 0, a = 0, s = ""; o = i.charAt(
								a++); ~o && (t = r % 4 ? 64 * t + o : o, r++ % 4) && (s += String.fromCharCode(255 &
								t >> (-2 * r & 6)))) o = function(e, t, o) {
							if ("function" == typeof Array.prototype.indexOf) return Array.prototype.indexOf
								.call(e, t, o);
							var n;
				...
				[133, 2628, 156, 340, 267, 272, 270, 288, 321, 326, 324, 338, 352, 2575, 786, 790, 788, 869,
					904, 908, 906, 944, 945, 949, 947, 983, 991, 995, 993, 1085, 1133, 1217, 1138, 1142, 1140,
					1146, 1147, 1151, 1149, 1217, 1336, 1375, 1359, 1369, 1367, 1372, 1376, 1338, 1508, 1547,
					1531, 1541, 1539, 1544, 1548, 1510, 1813, 1818, 1816, 2036, 2073, 2078, 2076, 2174, 2172,
					2062, 2213, 2218, 2216, 2389, 2387, 2205, 2576, 354
				]
			]), I)
}();
U.g = function() {
	...
	function t(e) {
		return function(e) {
			...
			var o, n, i, r, a, s = 1732584193,
				...
				l = -1732584194,
				p = 271733878;
			for (o = 0; o < e.length; o += 16) c = f(c = f(c = f(c = f(c = h(c = h(c = h(c = h(c = m(c = m(
										c = m(c = m(c = u(c = u(c = u(c = u(i = c, l = u(r =
															l, p = u(a = p, s = u(
																	n = s, c, l, p,
																	e[o], 7, -
																	680876936), c,
															...
															l, p = u(p, s = u(s, c, l,
																...
																1200080426), s, c, e[o +
																6], 17, -1473231341), p,
														s, e[o + 7], 22, -45705983), l =
													u(l, p = u(p, s = u(s, c, l, p, e[
																o + 8], 7,
															1770035416), c, l, e[o +
															9], 12, -1958414417), s, c,
														e[o + 10], 17, -42063), p, s, e[
														o + 11], 22, -1990404162), l =
												u(l, p = u(p, s = u(s, c, l, p, e[o +
															12], 7, 1804603682), c, l,
														e[o + 13], 12, -40341101), s, c,
													e[o + 14], 17, -1502002290), p, s,
												e[o + 15], 22, 1236535329), l = m(l, p =
												m(p, s = m(s, c, l, p, e[o + 1], 5, -
														165796510), c, l, e[o + 6], 9, -
													1069501632), s, c, e[o + 11], 14,
												643717713), p, s, e[o], 20, -373897302), l =
											m(l, p = m(p, s = m(s, c, l, p, e[o + 5], 5, -
														701558691), c, l, e[o + 10], 9,
													38016083), s, c, e[o + 15], 14, -
												660478335), p, s, e[o + 4], 20, -405537848),
										l = m(l, p = m(p, s = m(s, c, l, p, e[o + 9], 5,
												568446438), c, l, e[o + 14], 9, -
											1019803690), s, c, e[o + 3], 14, -187363961), p,
										s, e[o + 8], 20, 1163531501), l = m(l, p = m(p, s =
											m(s, c, l, p, e[o + 13], 5, -1444681467), c, l,
											e[o + 2], 9, -51403784), s, c, e[o + 7], 14,
										1735328473), p, s, e[o + 12], 20, -1926607734), l = h(l,
										p = h(p, s = h(s, c, l, p, e[o + 5], 4, -378558), c, l,
											e[o + 8], 11, -2022574463), s, c, e[o + 11], 16,
										1839030562), p, s, e[o + 14], 23, -35309556), l = h(l, p =
										h(p, s = h(s, c, l, p, e[o + 1], 4, -1530992060), c, l, e[
											o + 4], 11, 1272893353), s, c, e[o + 7], 16, -155497632
										), p, s, e[o + 10], 23, -1094730640), l = h(l, p = h(p, s =
									h(s, c, l, p, e[o + 13], 4, 681279174), c, l, e[o], 11, -
									358537222), s, c, e[o + 3], 16, -722521979), p, s, e[o + 6], 23,
								76029189), l = h(l, p = h(p, s = h(s, c, l, p, e[o + 9], 4, -
									640364487), c, l, e[o + 12], 11, -421815835), s, c, e[o + 15],
								16, 530742520), p, s, e[o + 2], 23, -995338651), l = f(l, p = f(p, s =
									f(s, c, l, p, e[o], 6, -198630844), c, l, e[o + 7], 10, 1126891415),
								s, c, e[o + 14], 15, -1416354905), p, s, e[o + 5], 21, -57434055), l = f(l,
								p = f(p, s = f(s, c, l, p, e[o + 12], 6, 1700485571), c, l, e[o + 3], 10, -
									1894986606), s, c, e[o + 10], 15, -1051523), p, s, e[o + 1], 21, -
							2054922799), l = f(l, p = f(p, s = f(s, c, l, p, e[o + 8], 6, 1873313359), c, l,
							e[o + 15], 10, -30611744), s, c, e[o + 6], 15, -1560198380), p, s, e[o + 13],
						21, 1309151649), l = f(l, p = f(p, s = f(s, c, l, p, e[o + 4], 6, -145523070), c, l,
						e[o + 11], 10, -1120210379), s, c, e[o + 2], 15, 718787259), p, s, e[o + 9], 21, -
					343485551),
				s = d(s, n),
				c = d(c, i),
				l = d(l, r),
...
function enc(data) {
	return I._getSecuritySign(data);
}
